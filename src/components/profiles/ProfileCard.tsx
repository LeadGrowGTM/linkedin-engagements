        ...
        <div className="flex items-start justify-between">
            <div className="flex-1">
              <div className="flex items-center gap-3">
                <div className="h-12 w-12 rounded-full bg-gradient-to-br from-primary-600 to-primary-800 flex items-center justify-center">
            ...
            {profile.Webhook && (
              <div className="mt-4 p-2 rounded bg-navy-50 dark:bg-navy-950">
                <p className="text-xs text-navy-500 dark:text-navy-400">Webhook URL</p>
                <p className="text-xs font-mono text-navy-900 dark:text-navy-50 truncate">
                  {profile.Webhook}
                </p>
              </div>
            )}
